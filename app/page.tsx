      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 w-full max-w-5xl">
          <Card>
            ...
            <CardContent>
              <p className="text-sm">
                カレンダービューやリスト表示で予約状況を一目で確認できます。
                ドラッグ＆ドロップで簡単に予約の変更が可能です。
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm">
                シーズン料金、部屋タイプ、宿泊人数に応じた料金を自動計算。 オプションやアドオンにも対応しています。
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm">予約データをBoardの見積もりと同期。 PDFの自動生成や顧客情報の連携が可能です。</p>
            </CardContent>
          </Card>
        </div>
      </div>
